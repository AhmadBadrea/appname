...
import 'package:appname/data/models/onbording_item.dart';
...
// -----------------------------------------------------------------------------
// البيانات الخاصة بصفحات العرض التقديمي
// -----------------------------------------------------------------------------
final List<OnboardingItem> _onboardingItems = [
  OnboardingItem(
    image: 'assets/images/splash1.jpg', // تأكد من وجود هذا المسار في pubspec.yaml
    title: 'اختر مكانك المثالي...',
    subtitle: 'ودع الراحة تبدأ بنقرة واحدة',
  ),
  OnboardingItem(
    image: 'assets/images/splash2.jpg', // تأكد من وجود هذا المسار في pubspec.yaml
...
// -----------------------------------------------------------------------------
// البيانات الخاصة بقائمة المحادثات
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// البيانات الخاصة بالرسائل داخل محادثة واحدة
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// البيانات الكاملة والمحدثة الخاصة بقائمة الشقق
// -----------------------------------------------------------------------------
