...
/// المصدر الوحيد للحقيقة لكل ما يتعلق بالثيم في التطبيق.
/// يحتوي على تعريفات كاملة ومتناسقة للوضعين النهاري والليلي.
class AppTheme {
  // يمنع إنشاء كائن من هذا الكلاس.
  AppTheme._();

  // ---------------------------------------------------------------------------
  // 1. التعريفات الموحدة (Shared Definitions)
  // ---------------------------------------------------------------------------

  /// النمط الموحد لكل الأزرار الرئيسية في التطبيق.
  static final _elevatedButtonStyle = ElevatedButton.styleFrom(
    ...
    textStyle: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600, fontFamily: 'Amiri'),
  );

  /// النمط الموحد لكل الكروت في التطبيق.
  static final _cardShape = RoundedRectangleBorder(
    borderRadius: BorderRadius.circular(15),
  );

  /// النمط الموحد لكل حقول الإدخال في التطبيق.
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
      titleLarge: TextStyle(color: AppColors.light.text, fontSize: 22, fontWeight: FontWeight.bold),
      titleMedium: TextStyle(color: AppColors.light.text, fontWeight: FontWeight.bold, fontSize: 16),
      ...
      labelLarge: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600, fontFamily: 'Amiri'),
    ),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    textTheme: TextTheme(
      titleLarge: TextStyle(color: AppColors.dark.text, fontSize: 22, fontWeight: FontWeight.bold),
      titleMedium: TextStyle(color: AppColors.dark.text, fontWeight: FontWeight.bold, fontSize: 16),
      bodyMedium: TextStyle(color: AppColors.dark.text.withOpacity(0.87), fontSize: 14),
